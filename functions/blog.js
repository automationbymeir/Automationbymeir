...
const UI = {
  en: {
    blog: "Blog",
    sub: "Practical automation notes: Power Automate, Apps Script, AI workflows and integrations.",
  ...
  he: {
    blog: "בלוג",
    sub: "רשימות פרקטיות על אוטומציה: Power Automate, Apps Script, תהליכי AI ואינטגרציות.",
